# Release Gold Deployments Wave 1b

This repository contains the `ReleaseGold` configurations that will be deployed in the wave 1b deploy on 04/30/20.
...
For you to reference to perform actions on your contract. You can find more information on `ReleaseGold` [here](https://github.com/celo-org/celo-monorepo/blob/master/packages/docs/celo-codebase/protocol/release-gold/README.md)
